//
//  ContactSocialMediaDetailViewController.swift
//  Unify
//
...
class ContactSocialMediaDetailViewController: UIViewController {
    ...
    @IBAction func doneEditing(_ sender: Any) {
        ...
        if mediaTextField.text == ""{
            ...
            ContactManager.sharedManager.newContact.setSocialLinks(socialLink: mediaTextField.text!)
            print(ContactManager.sharedManager.newContact.socialLinks)
    ...
    func postNotification() {
        ...
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "Contact Media Selected"), object: self)
